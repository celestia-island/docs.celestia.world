...
* Assumer la responsabilité de nos erreurs, présenter des excuses aux personnes concernées et apprendre de l'expérience
...
* L'usage de langage ou d'imagerie à connotation sexuelle, ainsi que toute forme d'attention ou de avances sexuelles
* Le trollage, les commentaires insultants ou dégradants, ainsi que les attaques personnelles ou politiques
* Le harcèlement public ou privé
* La publication d'informations privées d'autrui, telles qu'une adresse postale ou électronique, sans son autorisation explicite
* Tout autre comportement qui pourrait raisonnablement être considéré comme inapproprié dans un cadre professionnel

## Responsabilités d'application

Les responsables de la communauté sont chargés de clarifier et de faire appliquer nos normes de comportement acceptable et prendront des mesures correctives appropriées et équitables en réponse à tout comportement qu'ils jugent inapproprié, menaçant, offensant ou nuisible.

Les responsables de la communauté ont le droit et la responsabilité de supprimer, modifier ou rejeter les commentaires, commits, code, modifications de wiki, tickets et autres contributions qui ne sont pas alignés sur ce Code de conduite, et expliqueront les raisons de leurs décisions de modération lorsque cela est approprié.

## Portée

Ce Code de conduite s'applique dans tous les espaces de la communauté, et s'applique également lorsqu'un individu représente officiellement la communauté dans des espaces publics. Voici des exemples de représentation de notre communauté : utiliser une adresse électronique officielle, publier via un compte officiel de média social, ou agir en tant que représentant désigné lors d'un événement en ligne ou hors ligne.
...
Les responsables de la communauté suivront ces Directives d'impact sur la communauté pour déterminer les conséquences de toute action qu'ils jugent contraire à ce Code de conduite :

### 1. Correction

**Impact sur la communauté** : Usage d'un langage inapproprié ou autre comportement jugé non professionnel ou indésirable dans la communauté.

**Conséquence** : Un avertissement écrit et privé de la part des responsables de la communauté, apportant des précisions sur la nature de la violation et une explication du caractère inapproprié du comportement. Des excuses publiques peuvent être demandées.

### 2. Avertissement

**Impact sur la communauté** : Une violation résultant d'un incident unique ou d'une série d'actions.

**Conséquence** : Un avertissement avec des conséquences en cas de comportement continu. Pendant une période déterminée, aucune interaction avec les personnes impliquées, y compris toute interaction non sollicitée avec celles qui appliquent le Code de conduite. Cela inclut d'éviter les interactions dans les espaces de la communauté ainsi que dans les canaux externes comme les médias sociaux. Le non-respect de ces conditions peut entraîner un bannissement temporaire ou permanent.
...
**Conséquence** : Un bannissement temporaire de toute forme d'interaction ou de communication publique avec la communauté pendant une période déterminée. Pendant cette période, aucune interaction publique ou privée avec les personnes impliquées n'est autorisée, y compris toute interaction non sollicitée avec celles qui appliquent le Code de conduite. Le non-respect de ces conditions peut entraîner un bannissement permanent.

### 4. Bannissement permanent

**Impact sur la communauté** : La démonstration d'un schéma de violation des normes de la communauté, y compris un comportement inapproprié soutenu, le harcèlement d'un individu, ou l'agression ou le dénigrement envers des catégories de personnes.

...
Web UI(arona 채팅) 및 관리 패널(malkuth)은 자매 저장소 [shittim-chest](https://github.com/celestia-island/shittim-chest)로 이전되었으며 본 코드베이스에서 제거되었습니다. 본 저장소의 기본 인터페이스는 TUI입니다.

...
<p align="center"><strong>Tipos de protocolo compartilhados para a plataforma celestia-island</strong></p>
...
Fonte: [arona](https://github.com/celestia-island/plana).

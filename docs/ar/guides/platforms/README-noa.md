...
**نظام تحكم بالإصدارات موزع أصلي للذكاء الاصطناعي**
...
عزل مساحة عمل لكل وكيل، وسجلات JSONL للإلحاق فقط، وتاريخ قائم على اللقطات، وتوافق كامل مع بروتوكول git.

## التوثيق

البنية والتصميم والأدلة متوفرة على [docs.celestia.world/en/noa](https://github.com/celestia-island/docs.celestia.world/tree/master/docs/en).

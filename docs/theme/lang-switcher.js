(function () {
  ...
  var LANGUAGES = [
    ...
    { code: 'de', label: 'Deutsch', prefix: '/de', browserLangs: ['de'] },
    { code: 'pt', label: 'Português', prefix: '/pt', browserLangs: ['pt-br', 'pt-pt', 'pt'] },
    { code: 'ar', label: 'العربية', prefix: '/ar', browserLangs: ['ar'] }
  ];

  var NOTIFICATION_DISMISSED_KEY = 'celestia-lang-notification-dismissed';
  ...
  var NOTIFICATION_TEXTS = {
    ...
    'de': { message: 'Diese Dokumentation ist auch auf Deutsch verfügbar.', action: 'Auf Deutsch wechseln', dismiss: 'Schließen' },
    'pt': { message: 'Esta documentação está disponível em português.', action: 'Mudar para português', dismiss: 'Fechar' },
